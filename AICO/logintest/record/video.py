...
class VideoCamera(object):
    ...
    def update(self):
        move = pd.read_excel(
            'C:\\Users\\multicampus\\Desktop\\gogo\\S08P12C102\\web\\logintest\\record\\real_test_Ver1.xlsx')
        ...
        while 1:
            ...
            elif first == 0 and zero == 1 and self.ans == 1 :  
                first = 1
                zero = 0
                cycle01 += 1
                
                
            elif first == 1 and zero == 1 and self.ans == 0 :
                first = 0
                zero = 1
                cycle10 += 1
                
            elif second == 0 and first == 0 and self.ans == 2 :
                second = 1
                cycle02 += 1
            ...
            elif cycle01 == 1 and cycle10 >= 1 and cycle02 == 1 :
